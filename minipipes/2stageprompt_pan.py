...
if __name__ == "__main__":
    ...
    parser.add_argument("--text_prompts", type=str, default="pancreas,liver,right kidney,left kidney,spleen,stomach,gallbladder", help="Comma-separated text prompts for segmentation")
