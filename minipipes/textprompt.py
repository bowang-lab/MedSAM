...
def main(args):
    ...
    for fname in nii_files:
        ...
        for prompt in reversed(prompts): #reversed, so that we can have the last prompt on top in the composed mask
            seg = segment_image(img_data, model_demo, prompt=prompt, use_otsu=args.use_otsu, 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--prompts", type=str, default="liver,pancreas,right kidney,left kidney,spleen,stomach,gallbladder", help="Comma-separated text prompts for segmentation, in the order of importance. Default is 'liver'.")
